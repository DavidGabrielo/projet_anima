...
class Model extends Database
{
    ...
    {
        return $this->getconnexion()->query("SELECT * FROM classe WHERE niveau = $id AND categorie = 1 ORDER BY id")->fetchAll(PDO::FETCH_OBJ);
    }
    ...
    public function lectureSansId()
    {
        ...
        if (count($tabNiveau) > 0) {
            ...
            return $this->getconnexion()->query("SELECT * FROM classe WHERE niveau = $idNiveau AND categorie = 1 ORDER BY id")->fetchAll(PDO::FETCH_OBJ);
        }
    }
